...
static void EchoTxRx (std::string context, const Ptr< const Packet > packet, const TcpHeader &header, const Ptr< const TcpSocketBase > socket)
{
    ...
    /* Sample Output
        +8.10054e+08ns:/NodeList/26/$ns3::TcpL4Protocol/SocketList/0/Rx:0:0x641cd5696e40:0
        +8.10054e+08ns:/NodeList/26/$ns3::TcpL4Protocol/SocketList/0/Tx:92:0x641cd5696e40:0
    */ 
